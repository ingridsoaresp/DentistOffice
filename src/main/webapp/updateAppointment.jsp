...
<main>
    <div class="card">
        ...
        <p>
            Edit the appointment information below.
        </p>
        ...
        <form action="AppointmentUpdateServlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="apptDateTime" name="apptDateTime" value="<%= a.getApptDateTime() %>" />
            </div>

            <div class="form-group">
                <label for="patId">Patient ID</label>
                <input type="text" id="patId" name="patId" value="<%= a.getPatId() %>" />
            </div>

            <div class="form-group">
                <label for="dentId">Dentist ID</label>
                <input type="text" id="dentId" name="dentId" value="<%= a.getDentId() %>" />
            </div>

            <div class="form-group">
                <label for="procCode">Procedure Code</label>
                <input type="text" id="procCode" name="procCode" value="<%= a.getProcCode() %>" />
            </div>

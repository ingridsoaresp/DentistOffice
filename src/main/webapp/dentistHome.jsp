...
<head>
    ...
    <style>
        ...
        .logout-group { margin-top: 14px; text-align: center; }
...
<main>
    <div class="card">
        ...
        <h1>Welcome Dr. <%= d.getLastName() %>!</h1>

        <p>
            Manage patients, appointments, and office records.
        </p>
        ...
        <div class="btn-group">
            <a class="button" href="updateDentist.jsp">Edit Information</a>
            <a class="button" href="DentistAppointmentServlet">View Appointments</a>
        </div>

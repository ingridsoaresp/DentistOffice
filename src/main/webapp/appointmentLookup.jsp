...
<main>
    <div class="card">
        ...
        <p>
            Enter the appointment date and time to view details.
        </p>

        <form action="AppointmentLookupServlet" method="post">

            <div class="form-group">
                <label for="firstName">Patient First Name</label>
                <input type="text" id="firstName" name="firstName" placeholder="Enter patient first name" />
            </div>

            <div class="form-group">
                <label for="lastName">Patient Last Name</label>
                <input type="text" id="lastName" name="lastName" placeholder="Enter patient last name" />
            </div>

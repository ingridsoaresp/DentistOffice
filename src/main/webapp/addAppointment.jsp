...
<main>
    <div class="card">
        ...
        <p style="color: #b42318; font-weight: bold;">
            <%= errorMessage %>
        </p>
        <% } %>
        ...
        <form action="AppointmentAddServlet" method="post">
            ...
            <div class="form-group">
                <label for="apptDateTime">Appointment Date & Time</label>
                <input type="text" id="apptDateTime" name="apptDateTime" placeholder="Example: May 10, 2026, 2pm" />
            </div>

            <div class="form-group">
                <label for="patId">Patient ID</label>
                <input type="text" id="patId" name="patId" placeholder="Example: A900" />
            </div>

            <div class="form-group">
                <label for="dentId">Dentist ID</label>
                <input type="text" id="dentId" name="dentId" placeholder="Example: D201" />
            </div>

            <div class="form-group">
                <label for="procCode">Procedure Code</label>
                <input type="text" id="procCode" name="procCode" placeholder="Example: P321" />
            </div>
        ...
        <a class="back-link" href="patientHome.jsp">← Back to Home</a>
